...
!function (e) {
    ...
    if (!document.createEvent) {
        var c = !0, f = !1, d = "onreadystatechange", p = "DOMContentLoaded", v = "__IE8__" + Math.random(),
            m = e.Object, h = m.defineProperty || function (e, t, n) {
                e[t] = n.value
            ...
            }, y = m.getOwnPropertyDescriptor, b = m.prototype.hasOwnProperty, w = e.Element.prototype,
        ...
        r(e.HTMLCommentElement.prototype, w, "nodeValue"), r(e.HTMLScriptElement.prototype, null, "text"), r(x, null, "nodeValue"), r(e.HTMLTitleElement.prototype, null, "text"), h(e.HTMLStyleElement.prototype, "textContent", function (e) {
            ...
            addEventListener: {
                value: function (e, n, r) {
                    var o, a = this, l = "on" + e, s = a[v] || h(a, v, {value: {}})[v], c = s[l] || (s[l] = {}),
                        f = c.h || (c.h = []);
                    if (!b.call(c, "w")) {
                        if (c.w = function (e) {
            ...
            addEventListener: {
                value: function (e, t, n) {
                    var r = this, o = "on" + e, a = r[v] || h(r, v, {value: {}})[v], l = a[o] || (a[o] = {}),
                        s = l.h || (l.h = []);
            ...
            getComputedStyle: {
                ...
                value: function (t, n, r) {
                    var o = "on" + t, a = (e[o] || m)[v], l = a ? i(a, n) : -1;
                    l > -1 && a.splice(l, 1)
                }
            }
        })
    ...
    return function t(e, n, r) {
        ...
        3: [function (e, t, n) {
            "use strict";
            var r, o = e("../flowplayer"), i = e("../common"), a = e("./embed"), l = e("extend-object"), s = e("bean");
            r = function (e, t) {
                function n(e) {
                    function t(e) {
                ...
                var f, d, p, v = e.conf, m = (e.video, window, {
                    engineName: r.engineName, pick: function (t) {
                        if (o.support.flashVideo) {
                            for (var n, r, i = 0; i < t.length; i++) if (r = t[i], /mp4|flv|flash/i.test(r.type) && (n = r), e.conf.swfHls && /mpegurl/i.test(r.type) && (n = r), n && !/mp4/i.test(n.type)) return n;
                            return n
                        }
                    }, load: function (r) {
                        function h(e) {
                        ...
                        f = r;
                        var g = i.findDirect("video", t)[0] || i.find(".fp-player > video", t)[0], y = h(r.src),
                            b = /^https?:/.test(y), w = function () {
                                i.removeNode(g)
                            }, x = function (e) {
                        ...
                        if (b || E || (y = i.createAbsoluteUrl(y)), p && c(r) && p.data !== v.swfHls && m.unload(), p) {
                            ...
                            var k = !1;
                            if (!b && E) p.__set("rtmp", E.url || E); else {
                                var T = p.__get("rtmp");
                            ...
                            i.prepend(j, p), setTimeout(function () {
                                try {
                                    if (!p.PercentLoaded()) return e.trigger("error", [e, {code: 7, url: v.swf}])
                                } catch (t) {
                                }
        ...
        4: [function (e, t, n) {
            ...
            var l, s, u = e("../flowplayer"), c = e("bean"), f = e("class-list"), d = e("extend-object"),
                p = e("../common"), v = document.createElement("video"), m = {
                    ended: "finish",
                    pause: "pause",
                    play: "resume",
                    progress: "buffer",
            ...
            s = function (e, t) {
                    ...
                    return n.listeners && n.listeners.hasOwnProperty(l) ? void(n.listeners[l] = a) : ((n.listeners || (n.listeners = {}))[l] = a, c.on(o, "error", function (t) {
                        ...
                        i && t.addEventListener(o, function (s) {
                            if (a = n.listeners[l], s.target && f(s.target).contains("fp-engine") && ("progress" == i && s.srcElement && 0 === s.srcElement.readyState && setTimeout(function () {
                                    n.duration || e.conf.live && ("mpegurl" !== e.video.type || !b.hlsDuration) || (i = "error", e.trigger(i, {code: 4}))
                ...
                var o, v, g, y = p.findDirect("video", t)[0] || p.find(".fp-player > video", t)[0], b = u.support,
                ...
                return o = {
                    engineName: s.engineName, pick: function (e) {
                        ...
                        var o = !1, i = p.find(".fp-player", t)[0], a = !1;
        ...
        12: [function (e, t, n) {
            ...
            r(function (e, t) {
                ...
                var p = o({active: "is-active", advance: !0, query: ".fp-playlist a"}, e.conf), v = p.active, m = a(t);
                e.play = function (t) {
                ...
                e.conf.playlist.length && (h = !0, d(), e.conf.clip && e.conf.clip.sources.length || (e.conf.clip = e.conf.playlist[0])), n().length && !h && (e.conf.playlist = [], n().forEach(function (t) {
                    ...
                    if (e.conf.playlist.length) {
                        var s = r()[0], u = s && s.getAttribute("data-index"),
                            c = i.index = i.index || e.video.index || 0, f = l.find('a[data-index="' + c + '"]', t)[0],
        ...
        16: [function (e, t, n) {
            ...
            !function () {
                ...
                var l = t(), s = navigator.userAgent, u = n.msie || /Trident\/7/.test(s),
                    ...
                    p = /Android/.test(s) && !/Firefox/.test(s), v = /Android/.test(s) && /Firefox/.test(s),
                    m = /Silk/.test(s), h = /IEMobile/.test(s),
        ...
        17: [function (e, t, n) {
            ...
            i(function (e, t) {
                ...
                t.appendChild(m);
                var h = (n("progress"), n("buffer")), g = n("elapsed"), y = n("remaining"), b = n("waiting"),
                    w = n("ratio"), x = n("speed"), E = l(x), k = n("duration"), T = n("controls"),
                    S = n("timeline-tooltip"), N = a.css(w, "padding-top"), C = n("timeline"), O = u(C, e.rtl),
                    j = (n("volume"), n("fullscreen")), P = n("volumeslider"), A = u(P, e.rtl),
                ...
                e.on("ready", function (e, n, i) {
                    ...
                    var n = t.pageX || t.clientX, r = n - a.offset(C).left, i = r / a.width(C),
                        l = i * e.video.duration;
                    0 > i || (a.html(S, o(l)), a.css(S, "left", n - a.offset(T).left - a.width(S) / 2 + "px"))
                }), s.on(t, "contextmenu", function (e) {
                    var n = a.offset(t), r = window, o = e.clientX - n.left, i = e.clientY - (n.top + r.scrollY),
        ...
        18: [function (e, t, n) {
            ...
            function r(e, t, n) {
                ...
                var r, p, v = e, m = a(v), h = o({}, g.defaults, g.conf, t), w = {}, x = new b;
                m.add("is-loading");
                try {
                ...
                var T = {
                    ...
                    load: function (e, t) {
                        if (!T.error && !T.loading) {
                            ...
                            var n = S(e);
                            if (!n) return T.trigger("error", [T, {code: g.support.flashVideo ? 5 : 10}]);
                            ...
                            if (T.engine && n.engineName === T.engine.engineName || (T.ready = !1, T.engine && (T.engine.unload(), T.conf.autoplay = !0), p = T.engine = n(T, v), T.one("ready", function () {
                                ...
                                e.src = s.createElement("a", {href: e.src}).href;
            ...
            var v = /Safari/.exec(navigator.userAgent) && !/Chrome/.exec(navigator.userAgent),
                m = /(\d+\.\d+) Safari/.exec(navigator.userAgent), h = m ? Number(m[1]) : 100,
            ...
            if ("undefined" != typeof window.jQuery) {
                ...
                var x = function (e) {
                    ...
                    }).get(), t.sources = (new b).sourcesFromVideoTag(e, w), o(n, {clip: t})
                };
                w.fn.flowplayer = function (e, t) {
                    return this.each(function () {
                        "string" == typeof e && (e = {swf: e}), i(e) && (t = e, e = {});
                        var n = w(this), o = n.find('script[type="application/json"]'),
                            a = o.length ? JSON.parse(o.text()) : x(n.find("video")),
                            l = w.extend({}, e || {}, a, n.data()), s = r(this, l, t);
        ...
        19: [function (e, t, n) {
            ...
            e("./ext/support"), e("./engine/embed"), e("./engine/html5"), e("./engine/flash"), e("./ext/ui"), e("./ext/keyboard"), e("./ext/playlist"), e("./ext/cuepoint"), e("./ext/subtitle"), e("./ext/analytics"), e("./ext/embed"), e("./ext/fullscreen"), e("./ext/mobile"), r(function (e, t) {
                ...
                var o = function (e, t) {
                    ...
                    }, a = e.conf, l = r.common, s = l.createElement,
                    u = a.swf.indexOf("flowplayer.org") && a.e && t.getAttribute("data-origin"),
                    c = u ? n(u) : l.hostname(), f = (document, a.key);
                ...
                if (f && "function" == typeof key_check && key_check(f, c)) {
                    if (a.logo) {
                        var p = s("a", {href: u, className: "fp-logo"});
                        a.embed && a.embed.popup && (p.target = "_blank");
                        var v = s("img", {src: a.logo});
                    ...
                    var p = s("a", {href: "http://flowplayer.org"});
                    t.appendChild(p);
                    var m = s("div", {className: "fp-context-menu"}, '<!--ul><li class="copyright">&copy; 2015</li><li><a href="http://flowplayer.org">About Flowplayer</a></li><li><a href="http://flowplayer.org/license">GPL based license</a></li></ul-->'),
                    ...
                    7 !== h && t.appendChild(m), e.on("pause resume finish unload ready", function (e, n) {
                        ...
                        var r = -1;
                        if (n.video.src) {
                            var o = [["org", "flowplayer", "drive"], ["org", "flowplayer", "my"]];
                            for (var a in o) if (r = n.video.src.indexOf("://" + o[a].reverse().join(".")), -1 !== r) break
                        }
        ...
        20: [function (t, n, r) {
            !function (t, r, o) {
                ...
                var n, r = window, o = t[e], i = /[^\.]*(?=\..*)\.|.*/, a = /\..*/, l = "addEventListener",
                    ...
                    d = f ? l : "attachEvent", p = {}, v = Array.prototype.slice, m = function (e, t) {
                        return e.split(t || " ")
                    }, h = function (e) {
                    ...
                    w = function (e, t, n) {
                        ...
                        var e = m("altKey attrChange attrName bubbles cancelable ctrlKey currentTarget detail eventPhase getModifierState isTrusted metaKey relatedNode relatedTarget shiftKey srcElement target timeStamp type view which propertyName"),
                            ...
                            i = e.concat(m("data")), a = e.concat(m("touches targetTouches changedTouches scale rotation")),
                            l = e.concat(m("data origin source")), s = e.concat(m("state")), f = /over|out/, d = [{
                        ...
                        var r = function (t, r) {
                            for (var o, i = h(e) ? n(e, r) : e; t && t !== r; t = t.parentNode) for (o = i.length; o--;) if (i[o] === t) return t
                        }, o = function (e) {
                        ...
                        if (o = u && t.replace(a, ""), o && x[o] && (o = x[o].base), !t || u) (l = u && t.replace(i, "")) && (l = m(l, ".")), P(e, o, n, l); else if (g(t)) P(e, null, t); else for (r in t) t.hasOwnProperty(r) && D(e, r, t[r]);
                        return e
                    }, M = function (e, t, r, o) {
                        var l, s, u, c, f, h, y;
                        {
                        ...
                        var r, o, l, s, u, c = m(t);
                        for (r = c.length; r--;) if (t = c[r].replace(a, ""), (s = c[r].replace(i, "")) && (s = m(s, ".")), s || n || !e[d]) for (u = S.get(e, t, null, !1), n = [!1].concat(n), o = 0, l = u.length; l > o; o++) u[o].inNamespaces(s) && u[o].handler.apply(e, n); else _(w[t], t, e);
                        return e
                    }, R = function (e, t, n) {
        ...
        21: [function (t, n, r) {
            (function (t) {
                !function (o) {
                    ...
                    function p(e) {
                        var t, n, r, o, a, l, s, f, p, v, m = [], h = e.length, g = 0, y = j, b = O;
                    ...
                    function v(e) {
                        ...
                        for (r = o = w.length, o && w.push(P); h > r;) {
                            ...
                            for (g = r + 1, u - t > F((E - n) / g) && i("overflow"), n += (u - t) * g, t = u, l = 0; h > l; ++l) if (m = e[l], t > m && ++n > E && i("overflow"), m == t) {
                    ...
                    var g = "object" == typeof r && r, y = "object" == typeof n && n && n.exports == g && n,
                        b = "object" == typeof t && t;
                    (b.global === b || b.window === b) && (o = b);
                    var w, x, E = 2147483647, k = 36, T = 1, S = 26, N = 38, C = 700, O = 72, j = 128, P = "-",
                        A = /^xn--/, _ = /[^ -~]/, D = /\x2E|\u3002|\uFF0E|\uFF61/g, M = {
                            overflow: "Overflow: input needs wider integers to process",
                            "not-basic": "Illegal input >= 0x80 (not a basic code point)",
                            "invalid-input": "Invalid input"
                        }, L = k - T, F = Math.floor, I = String.fromCharCode;
                    if (w = {
                            version: "1.2.4",
        ...
        25: [function (t, n, r) {
            !function (t, o) {
                ...
                var e, t = Array.prototype, n = Object.prototype, r = Function.prototype, o = String.prototype,
                    ...
                    m = Function.prototype.toString, h = function (e) {
                        try {
                            return m.call(e), !0
                        } catch (t) {
                            return !1
                ...
                var F = Object("a"), I = "a" !== F[0] || !(0 in F), R = function (e) {
                    var t = !0, n = !0;
                ...
                O(t, {
                    forEach: function (t) {
                        var n, r = P.ToObject(this), o = I && k(this) ? this.split("") : r, i = -1, a = o.length >>> 0;
                    ...
                    map: function (t) {
                        var n, r = P.ToObject(this), o = I && k(this) ? this.split("") : r, i = o.length >>> 0,
                            a = Array(i);
                    ...
                    filter: function (t) {
                        var n, r, o = P.ToObject(this), i = I && k(this) ? this.split("") : o, a = i.length >>> 0,
                            l = [];
                ...
                t.reduce && (V = "object" == typeof t.reduce.call("es5", function (e, t, n, r) {
                    ...
                    reduce: function (t) {
                        var n = P.ToObject(this), r = I && k(this) ? this.split("") : n, o = r.length >>> 0;
                ...
                O(t, {
                    indexOf: function (e) {
                        var t = I && k(this) ? this.split("") : P.ToObject(this), n = t.length >>> 0;
                        if (0 === n) return -1;
                        var r = 0;
                ...
                var q = !{toString: null}.propertyIsEnumerable("toString"), z = function () {
                ...
                O(Object, {
                    keys: function (t) {
                        ...
                        if (q) for (var c = t.constructor, f = c && c.prototype === t, d = 0; B > d; d++) {
                            var p = Y[d];
                ...
                (!Date.parse || ne || te || !ee) && (Date = function (e) {
                    var t = function (n, r, o, i, a, l, s) {
                            ...
                            return u = this instanceof e ? 1 === c && String(n) === n ? new e(t.parse(n)) : c >= 7 ? new e(n, r, o, i, a, l, s) : c >= 6 ? new e(n, r, o, i, a, l) : c >= 5 ? new e(n, r, o, i, a) : c >= 4 ? new e(n, r, o, i) : c >= 3 ? new e(n, r, o) : c >= 2 ? new e(n, r) : c >= 1 ? new e(n) : new e : e.apply(this, arguments), O(u, {constructor: t}, !0), u
                        },
                    ...
                    O(t, {now: e.now, UTC: e.UTC}, !0), t.prototype = e.prototype, O(t.prototype, {constructor: t}, !0);
                    var l = function (t) {
                        var r = n.exec(t);
                        if (r) {
                            var a, l = Number(r[1]), s = Number(r[2] || 1) - 1, u = Number(r[3] || 1) - 1,
                                c = Number(r[4] || 0), f = Number(r[5] || 0), d = Number(r[6] || 0),
                                p = Math.floor(1e3 * Number(r[7] || 0)), v = Boolean(r[4] && !r[8]),
                ...
                var ce = "	\n\f\r   ᠎             　\u2028\u2029\ufeff", fe = "​", de = "[" + ce + "]",
                    pe = new RegExp("^" + de + de + "*"), ve = new RegExp(de + de + "*$"),
